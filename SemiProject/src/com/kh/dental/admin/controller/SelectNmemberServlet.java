 ...
 */
@WebServlet("/Nmember.ad")
public class SelectNmemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectNmemberServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//페이징 처리 추가
				...
				ArrayList<Admin> list = new AdminService().NmemberselectList(currentPage, limit);
