...
/**
 * Servlet implementation class SelectBoardEventServlet
 */
@WebServlet("/selectboev.ad")
public class SelectBoardEventServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectBoardEventServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = as.getBoEvListCount();
		...
		ArrayList<AdminEvent> list = new AdminService().BoEvselectList(currentPage, limit);
		...
		if(list != null){
			...
			response.sendRedirect("views/admin/AdminMain_event.jsp");
		} else {
