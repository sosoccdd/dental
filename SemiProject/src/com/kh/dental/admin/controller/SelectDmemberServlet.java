 ...
 */
@WebServlet("/Dmember.ad")
public class SelectDmemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectDmemberServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//페이징 처리 추가
				...
				int listCount = as.getDmemberListCount();
				...
				ArrayList<Admin> list = new AdminService().DmemberselectList(currentPage, limit);
				...
				if(list != null){
					...
					response.sendRedirect("views/admin/AdminMain_D.jsp");
				} else {
