...
public class SelectApprovalServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = as.getApprovalListCount();
		...
		ArrayList<Admin> list = new AdminService().ApprovalselectList(currentPage, limit);
		...
		if(list != null){
			...
			response.sendRedirect("views/admin/AdminMain_approvalC.jsp");
		} else {
