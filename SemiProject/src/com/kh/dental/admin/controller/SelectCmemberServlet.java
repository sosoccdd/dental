...
/**
 * Servlet implementation class SelectNmemberServlet
 */
@WebServlet("/Cmember.ad")
public class SelectCmemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectCmemberServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//페이징 처리 추가
				...
				int listCount = as.getCmemberListCount();
				...
				ArrayList<Admin> list = new AdminService().CmemberselectList(currentPage, limit);
				...
				if(list != null){
					...
					response.sendRedirect("views/admin/AdminMain_C.jsp");
				} else {
