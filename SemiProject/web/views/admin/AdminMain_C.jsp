...
<body>
   ...
   <div class="w3-bar w3-sand">
    ...
    <a onclick="goCmember()" class="w3-bar-item w3-button test-a-tag">병원</a>
  </div>
  ...
  <table class="w3-table-all w3-hoverable">
    ...
    <tr>
      ...
      <td>
      <button onclick="updateCmember('<%=ad.getmId() %>','<%=ad.getmName() %>');" class="w3-white w3-border w3-border-blue w3-round">탈퇴</button>
      </td>
    </tr>
...
<script type="text/javascript">
	function updateCmember(mId, mName){
		location.href='/semi/UpdateCmember.ad?mId='+mId+'&mName='+mName;
