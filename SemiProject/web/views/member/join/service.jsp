...
<b>제 1 조 (목적)</b><br>
이 약관은  조은치과 ("회사" 또는 "조치")가 제공하는 조치 및 조치 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.<br>
<br>
<b>제 2 조 (정의)</b><br>
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br>
<br>
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 조치 및 조치 관련 제반 서비스를 의미합니다.<br>
...
1.검색 서비스<br>
2.개방형 서비스(블로그, 카페 등)<br>
3.게시판형 서비스(지식iN, 뉴스 등)<br>
4.메일서비스<br>
5.보안패치, 백신서비스<br>
...
- 게시중단요청서비스 : http://help.great_dental.com<br>
