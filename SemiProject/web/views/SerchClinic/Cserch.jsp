...
<body>
	...
	<div>
		<div class="first-div">
			...
			<select class="select-tag f17" name="sido" id="sido">
				<option class="f17" value="">-시도-</option>
			</select> 
			<select class="select-tag f17" name="gugun" id="gugun">
				<option class="f17" value="">-구군-</option>

			</select> 
			<select class="select-tag f17" name="dong" id="dong">
				<option class="f17" value="">-동-</option>
			</select> 
			<button type="button" onclick="test01();" id="selectsearch">검색하기</button>
			...
			$("#selectsearch").click(function(){
				...
				$.ajax({
					...
					success:function(data){
						...
						x_pos_test+=data[i].x_pos;
						y_pos_test+=data[i].y_pos;
	...
	<div>
		<div class="first-div map-tag f20" id="map">
		</div>
